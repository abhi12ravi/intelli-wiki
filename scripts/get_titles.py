...
def get_unprotected_titles(number_of_articles):
    ...
    with open('../protect-wiki/view_count_unprotected_articles.csv', encoding="utf-8") as fd:
...
def main():
    ...
    list_unprotected_articles = get_unprotected_titles(1204)

    # #Write title, ID and view_count to file
    initial_write_to_csv(list_unprotected_articles, "dataset/trial_1200/balanced_dataset.csv")

    #2. Get 52 sysop articles
    # number_of_articles = 1189
